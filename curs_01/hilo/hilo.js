...
function adaugaCartiInPachet(nrPachete = 1) {
  for (let i = 0; i < cardTypes.length; i++) {
    ...
    for (let j = 2; j <= 14; j++) {
      ...
      // pachet[cardTypes[i]][pachet[cardTypes[i]].length] = j; //alta varianta fata de push
    }
  }
  console.log(pachet);
}
...
function incarcare() {
  ...
  nouaCarte = schimbaCarte(); //ar urma comparatie
...
function schimbaCarte() {
  ...
  pachet[cardTypes[indexType]].splice(pozitie, 1); //functia splice sterge/adauga carti
  console.log(pachet);
